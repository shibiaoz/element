<style>
  ...
  <template>
      <demo-layout :menu="zybMenu" class="" >
          <div class="page-container page-component page-component__content">
  ...
  <script>
    ...
    import { zybMenu,zybZhCnNavMenu } from 'examples/constant/menu';
    export default {
      data() {
        return {
